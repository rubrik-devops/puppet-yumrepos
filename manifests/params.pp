class yumrepos::params {
  ...
  # Elasticsearch 5
  $elasticsearch5_url = "http://artifacts.elastic.co/packages/5.x/yum"
  $elasticsearch5_enabled = '1'
  $elasticsearch5_gpgcheck = '1'
  $elasticsearch5_includepkgs = absent
  $elasticsearch5_exclude = absent
